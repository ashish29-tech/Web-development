...
const {validateProduct, isLoggedIn, isSeller, isProductAuthor} =  require('../middleware'); //yha pe isLoggedIn ko require kar liya
...
router.get('/products/:id' , isLoggedIn, async(req,res)=>{ //detail dikhani hai to bhi log in hona chahiye
    try{
...
router.get('/products/:id/edit' , isLoggedIn, isSeller, async(req,res)=>{ //editing dikhana hai to bhi log in
    try{
...
//delete a route
router.delete('/products/:id' ,isLoggedIn, isSeller, isProductAuthor, async(req,res)=>{ //delete karne se bhi pehle login hona chahiye...
    try{
