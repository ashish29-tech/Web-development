...
//yha pe wahi karenge jo insertMany wala karna hai...
//seed db m dalega...uske liye hame mongoose chahiye..so require mongoose

const mongoose = require('mongoose'); //object
const Product = require('./models/Product'); //niche seedFunction time Prod type karenge and recommendations m.. ./models/Product ayega and uspe click kaenge toh yha require ho jayega automatically

const products = [ //Array bna diya products naam ka
  {
    name:"iphone 17pro",
    //unsplash pe jake copy image address
...
//now insertMany ki command chalani hai toh...function bna lete hai...
...
//  toh yha model chahiye hoga...and insertMany accepts an array toh yha array(products naam ka) diya. insertMany returns a promise..toh ise resolve kar lenge with the help of async and await
//upar jo products bna rakhe hai use insertMany kar dega
...
module.exports = seedDB; //seedDB ko kisi aur file m use karna hai...toh export kar liya so that jha chahiye wha require kar ke run kar sake..hamare case m app.js m chahiye toh wha require kar lenge
