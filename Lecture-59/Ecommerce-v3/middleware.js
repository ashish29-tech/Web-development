...
const validateProduct = (req,res,next)=>{ //middleware m req,res,next hota hai
  let {name, img,  price, desc} = req.body; //ye routes ke product.js se..actually adding se aya hai. req.body ka sara acces yha de diya..and request access toh hai hi hamare paas(parameter m req). 
  //validate method schema ke upar lagega...
