...
//V.V IMPORTANT FOR INTERVIEW

//AJAX= ASYNCHRONOUS JAVASCRIPT...XML..XTENSIBLE MARKUP LANGUAGE. Basically ek tarike ki markup language.
//HTML is also a markup language...usse milti julti hoti hai...XML
//AJAX is not any of the following: framework, library, PL, Runtime
//It's simlpy a web technique. A way to talk to web.


//Traditional request(Browser means client send request to server and server give response..and this cycle goes on) m page refresh/reload ho jata hai...response is a new page..with a combination of HTML,CSS< JS.
//Jisme(Traditional Request) reloading hoti hai use MPA(Multi Page Application) kehte hai.
//Isme SEO acha hota hai. Websites slow hoti hai.
...
//If response m sirf data aa rha hai..and no HTML and CSS...will reloading/refreshing hogi ? NO. So, websites will be faster.


//-----------------------------------------------------------------
//API: Application Programmable Interface
//Jo kaam sunkar hamara kaam karti hai wo API hoti hai. Ex: Remote of a TV.
//APIs gives us the data. 
//Search Free gitHub APIs...and click on https://github.com/public-apis/public-apis
