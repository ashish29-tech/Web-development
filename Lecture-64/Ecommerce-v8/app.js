...
const cartRoutes = require("./routes/cart"); //cart ka route
...
app.get("/" , (req,res) => { //jab bhi slash pe request jaye
    res.render("home"); //home ka page dikha do
})
...
app.use(cartRoutes); //yha cart routes jo upar bnaya use require kar liya
