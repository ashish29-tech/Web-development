...
//run karne keloye cookie parser ko middleware chahiye hoga
app.use(cookieParser('hiiamyoursecretteacher')); //secret
...
app.get('/', (req,res)=>{ //ye route bnaya..ye hame sare cookies lake de rha hai
  ...
  // res.send(req.cookies) //and ise send bhi kara lete hai
