...
function CaseTwo() {
  ...
  //let's see useRef() karta hai kya...
  let countRef = useRef(0); //is countRef ko initial/reference value deni padegi

  //function bna liya
  //useState state ko maintain nai karta b/w two renders
  function handleIncrement(){
    setCount(count + 1); //count ek state hai. setCount ko kahenge count ki value 1 se badha do. 0 se 1 kar rha hai...but nai ho rahi cuz setCount is not a synchronous task...ye kya karta hai baki kaam ko pehle hone deta hai...uske baad ye apne aap ko update karta hai..and upadted value next render(2nd time) pe milti hai...ye render 2 hai
    console.log("state: ", count); //count ki value ko console kiya...state ki value count hai...0 ayega....ye render number 1 hai. 
  ...
  function handleIncrement2(){
    ...
    countRef.current += 1; //increment karna tha
  ...
  return (
    <div>
      ...
      <br />
      {/* jaise hi is button ko click karenge toh ek event trigger hoga...onClick...upar function bna liya */}
